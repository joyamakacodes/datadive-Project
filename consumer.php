  ...
  <body>
    <nav class="navbar navbar-expand-lg bg-light" id="backcinto">
          ...
          <div class="collapse navbar-collapse" id="navbarScroll">
            <ul class="navbar-nav me-auto my-2 my-lg-0 navbar-nav-scroll" style="--bs-scroll-height: 100px;">
              ...
              <li class="nav-item">
                ...
                <a id="back-rottr" href="consumer.php" class="btn btn-sm active" type="button" >Consumer Intelligence Insights</a>
              </li>
       ...
       <div class="container">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <h2 style="text-align:center;font-weight: 700;margin-top: 100px;"><span style="color:#0d8744;">DATA</span>DIVE</h2>
                        <p style="text-align:center;">Let's create your access to unlimited services</p>
                    </div>
